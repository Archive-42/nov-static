...
const examples = {
  ...
  "view-edit": {
    ...
    component: ViewEdit,
    description:
      "FormBuilder makes it super easy to toggle view/edit mode of a form.",
  },
  "dynamic-fields": {
    name: "Dynamic Fields",
  ...
  "complex-layout": {
    ...
    description:
      "The example shows a complex layout. Similar approach with multiple columns.",
  },
  ...
  validation: {
    ...
    description: (
      <span>
        You can use rules property to specify how to validate fields. For more
    ...
    if (!item || !item.component) {
      return (
        <span style={{ color: "red" }}>
          Error: example "{current}" not found.
        </span>
      );
    }
      ...
      <div className="sider">
        ...
        <div className="scroll-container">
          ...
          <div className="social">
            ...
            <a href="https://github.com/rekit/antd-form-builder">
              <img
                src="https://img.shields.io/badge/API-Reference-green"
                alt="api reference"
              />
            </a>
            <br />
